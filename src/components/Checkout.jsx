...
import LogoGracias from "../assets/logo_thot.svg";
...
const Checkout = () => {
    ...
    const generarOrden = () => {
        ...
        const items = cart.map(item => ({id:item.idf, title:item.title, price:item.price}));
    ...
    return (
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-6">
                    <form>
                        ...
                        <button type="button" style={StyleButton} className="btn" onClick={generarOrden}>Generar Orden</button>
                    </form>
                </div>
            ...
            <div className="row my-5">
                <div className="col text-center">
                    {orderId ? <div style={StyleButton} className="alert p-5 text-center" role="alert">
                        <img src={LogoGracias} width={400} alt="Gracias" />
